<?php
class adminConsultantTaskListModule {
	function display($db = '', $params = array()) {
		...
		$taskList = $taskManagerContentObj->getAdminConsultantTaskList($params);
		
		$page  = ($params['page']) ? $params['page']  : 1;
		$limit = (int) $params['recCount'];
		$start = ($params['page'] - 1) * $limit;
		
		$totalRecords = getTotalRecords($taskList);
		...
		$smarty->assign('currentTabActive', $params['currentTabActive']);
		$smarty->assign('taskList', $taskList['taskList']);
