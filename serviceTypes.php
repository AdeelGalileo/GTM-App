...
$serviceTypeFilterArray = generateSelectOption($serviceTypeFilterArray,0);
$smarty->assign('serviceTypeFilterArray', $serviceTypeFilterArray);
...
$smarty->assign('lastPage', 'Service Types');
$smarty->display('serviceTypes.tpl');
