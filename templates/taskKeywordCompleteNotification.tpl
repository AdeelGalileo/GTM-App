                        ...
                        <td valign="top" align="center" width="100%" style="width:100%;padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                            <div class="ceditable">
                                 <p style="font-family:Century Gothic, sans-serif; text-align:center;  letter-spacing: 0px; line-height: 1.3; font-size:13px;
									 ...
									 {$taskKeywordData.attrUser} has completed the task <strong>{$taskKeywordData.attrServiceTypeName} ({$taskKeywordData.attrCode} - {$taskKeywordData.attrDivCode})</strong> for {$smarty.session.sessionClientName} on {$smarty.const.DB_DATE_TIME|date_format:$smarty.const.CALENDAR_DATE_TIME_FORMAT} 
                                </p>
