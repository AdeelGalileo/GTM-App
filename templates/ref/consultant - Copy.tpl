        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li><a href="javascript:void(0);">Outstanding Billing</a></li>
              <li><a href="javascript:void(0);">Submitted Billing</a></li>
              <li class="active"><a href="#tab_5" data-toggle="tab">Billing Due This Month</a></li>
            </ul>
            <div class="tab-content">
