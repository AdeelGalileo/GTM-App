                            ...
                            <div class="ceditable">
                                 <p style="font-family:Century Gothic, sans-serif; text-align:center;  letter-spacing: 0px; line-height: 1.3; font-size:13px;
                                     margin:3px;color:#222;"><br><br>
									  {$taskDataMessage}  <strong>{$taskData.attrServiceTypeName} ({$taskData.attrCode} - {$taskData.attrDivCode})</strong> for {$smarty.session.sessionClientName} on {$smarty.const.DB_DATE_TIME|date_format:$smarty.const.CALENDAR_DATE_TIME_FORMAT} 
                                </p>
